...
// ── If already logged in, go straight to About Me ──
...
// ──────────────────────────────────────────────────────────────────
// Read credentials from platform environment variables.
// Set these in:
//   Azure App Service  → Configuration > Application Settings
//   AKS                → ConfigMap or Secret mounted as env vars
//
// Keys to set:
//   LOGIN_USERNAME = rocketadmin
//   LOGIN_PASSWORD = Launch#2024!
//
// No .env file needed — the platform injects them at runtime.
// ──────────────────────────────────────────────────────────────────
$env_user = getenv('LOGIN_USERNAME') !== false
            ? getenv('LOGIN_USERNAME')
            : (isset($_SERVER['LOGIN_USERNAME']) ? $_SERVER['LOGIN_USERNAME'] : '');

$env_pass = getenv('LOGIN_PASSWORD') !== false
            ? getenv('LOGIN_PASSWORD')
            : (isset($_SERVER['LOGIN_PASSWORD']) ? $_SERVER['LOGIN_PASSWORD'] : '');
