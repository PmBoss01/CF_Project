...
<html lang="en">
  <head>
    ...
    <title>Manage Record | Voter</title>
    ...
    <div class="containerdb bg-light">
      ...
      <div class="maindb bg-light">
        <div class="container-fluid bg-light">
          ...
          <!--Voter Table-->
          <div class="tabledb shadow border-top bg-light" style="margin-top: 70px; margin-bottom:50px;";>
          <h2><i class="fa-solid fa-graduation-cap mx-2"></i>Managae Voters</h2>
          ...
          ?>
              ...
              <?php
                ...
                <tr>
                  ...
                  <td> 
                  <form action="UpdateVoterInfo.php" method="post">
                    <input type="hidden" name="editsid" value="<?php echo $row['Student_ID']?>">
                    <button type="submit" name="studenteditbtn" class="btn bg-success text-white"><i class="fa fa-pencil-square-o"></i></button>
                  </form>
                  </td>
                  <td>
                  <form action="Registrations_Conn.php" method="post">
                    <input type="hidden" name="deletesid" value="<?php echo $row['Student_ID']; ?>">
                    <button type="submit" name= "studentdeletebtn" class="btn bg-danger text-white"><i class="fa fa-trash"></i></button>
                  </form>
                  </td>
                  <td>
                  <form action="Registrations_Conn.php" method="post">
                    ...
                    <input type="hidden" name="SerialCode" value="<?php echo $row['Serial_Code']; ?>">
                    <button type="submit" name= "sendsmsbtn" class="btn bg-secondary text-white">Send SMS</button>
                  </form>
                  </td>
            ...
            <a class="btn btn-success mt-5" href="exportvoterslist.php" type="submit" name="exportbtn"><i class="fa fa-download mx-2" aria-hidden="true"></i>Export Voters List</a>
            </div>

            <form action="Truncate_VotersList.php" method="POST">
            <div class="d-grid gap-2">
            <button class="btn btn-danger mt-2" type="submit" name="truncatebtn"><i class="fa fa-trash mx-2" aria-hidden="true"></i>Remove All Voters</button>
          </div>
          </form>
        ...
        <div class="tabledb shadow border-top bg-light" style="margin-top: 20px; margin-bottom:50px;">
            <h2><i class="fa fa-paper-plane mx-2" aria-hidden="true"></i>Message To All Voters (Bulk)</h2>
            <form action="sendbulksms.php" method="POST" enctype="multipart/form-data">
              <p class="mt-1 text-center">When you turn on the <b>'Switch'</b> button by Clicking, you automatically accept that an SMS <br> will be sent to all registered voters, providing them with the latest updates on the upcoming election.</p>
              
              <div class="d-flex justify-content-center">
              <div class="form-check form-switch mt-2">
              <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="switchbtn" required>
              <label class="form-check-label mx-2 fw-bold" for="flexSwitchCheckDefault">Ready to Send SMS</label>
            </div>
            <button class="btn btn-secondary mb-2" name="sendbulksms"><i class="fa fa-paper-plane m-1" aria-hidden="true"></i>Send SMS</button>
            </div>
          ...
          <!--Validation Table-->
          <div class="tabledb shadow border-top bg-light" style="margin-top: 20px; margin-bottom:50px;";>
          <h2><i class="fa-solid fa-clipboard-check mx-2"></i>Validation Table</h2>
          ...
          ?>
              ...
              <?php
                ...
                <tr>
                  ...
                  if ($Action == "Voted"){
                    ?>
                    <td><label for="reg" class="bg-success text-white" style="border-radius: 5px;padding: 10px 15px;"><i class="fa-solid fa-check-to-slot mx-1"></i>Voted</label></td>
                    <?php
                  }else{
                    ?>
                    <td><label for="reg" class="bg-info text-white" style="border-radius: 5px;padding: 10px 12px;">Not Voted</label></td>
                    <?php
                  }
                  ?>
                  <?php
                  if ($Valid == "Validated"){
                    ?>
                    <td><label for="valid" class="bg-success text-white" style="border-radius: 5px;padding: 10px 15px;"><i class="fa-solid fa-circle-check mx-1"></i>Validated</label></td>
                    <?php
                  }else{
                    ?>
                    <td><label for="valid" class="bg-secondary text-white" style="border-radius: 5px;padding: 9px 12px;">Not Validated</label></td>
                    <?php
                  }
                  ?>
                  <?php
                  if ($sms == "SMS Sent"){
                    ?>
                    <td><label for="sms" class="bg-success text-white" style="border-radius: 5px;padding: 10px 17px;"><i class="fa-regular fa-paper-plane mx-1"></i>Sent</label></td>
                    <?php
                  }else{
                    ?>
                    <td><label for="sms" class="bg-secondary text-white" style="border-radius: 5px;padding: 10px 14px;">Not Sent</label></td>
                    <?php
                  }
                  ?>
