...
<html lang="en">
  <head>
    ...
    <title>Manage Record | Polling Agent</title>
  ...
  .circle span {
    border: 2px solid red; /* Adjust the border width and color as needed */
    border-radius: 50%;
    padding: 5px;
  }
    ...
    <div class="containerdb bg-light">
      ...
      <div class="maindb bg-light">
        <div class="container-fluid bg-light">
          ...
          <h2><i class="fa fa-user-check mx-2"></i>Managae Polling Agents</h2>
          ...
          ?>
              ...
              <?php
                ...
                <tr>
                  ...
                  <form action="pollingmanage_conn.php" method="post">
                    <input type="hidden" name="deletesid" value="<?php echo $row['Student_ID']; ?>">
                    <input type="hidden" name="agentid" value="<?php echo $row['Agent_ID']; ?>">
                    <button type="submit" name= "pollingdeletebtn" class="btn bg-danger text-white"><i class="fa fa-trash"></i></button>
                  </form>
                  </td>
            ...
            <a class="btn btn-success mt-5" href="exportpollinglist.php" type="submit" name="exportbtn"><i class="fa fa-download mx-2" aria-hidden="true"></i>Export Candidate List</a>
            </div>

            <form action="Truncate_VotersList.php" method="POST">
            <div class="d-grid gap-2">
            <button class="btn btn-danger mt-2" type="submit" name="truncatepollingbtn"><i class="fa fa-trash mx-2" aria-hidden="true"></i>Remove All Voters</button>
          </div>
          </form>
      ...
      <div class="container-fluid bg-light">
          ...
          <!--Voter Table-->
          <div class="tabledb shadow border-top bg-light" style="margin-top: 70px; margin-bottom:80px;";>
          <h2><i class="fa-regular fa-message mx-2"></i>Messages</h2>

          <div class="row">
            <div class="col-6">
              <form action="pollingMessage_Conn.php" method="POST">
              <p class="mt-1"><i class="fa-solid fa-paper-plane mx-1"></i>General Message To All Polling Agents</p>
              <div class="form-floating mb-2">
              <textarea class="form-control" placeholder="Enter Your Message" id="floatingTextarea2" name="textmsg" style="height: 100px" required></textarea>
              <label for="floatingTextarea2">Enter Your Message</label>
            </div>
            <button class="btn btn-secondary shadow float-end" type="submit" name="generalmsgbtn"><i class="fa-solid fa-paper-plane mx-1"></i>Send</button>
            </div>
            </form>

            <?php
        include "db_conn.php";
        $tableNames = ["chats"];  // Add your new table names
        ...
        foreach ($tableNames as $tableName) {
            ...
            <div class="col-6">
              <p class="text-center mt-1"><i class="fa-solid fa-comments mx-1"></i>Issue Report</p>
              <p class="text-center">To Read and Reply Issues Reported by Polling Agents.</p>
              <p class="text-center"><a href="EC_chatpage.php" type="button" class="btn btn-secondary btn-lg" style="font-size: 17px;"><i class="fa-solid fa-comments mx-1"></i>Issues Reported <span class="badge bg-danger rounded-pill"><?php echo $chats_count; ?></span></a></p>
            </div>
