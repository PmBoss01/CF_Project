...
<html lang="en">
  ...
  ></script> 
    ...
    <div class="containerdb bg-light">
      <div class="topbardb">
        <div class="logodb">
          <a href="Homepage.php" class="text-decoration-none text-dark"><h4>Pm E-Voting System</h4></a>
        </div>
        <div class="searchdb">
  ...
  <span class="position-absolute top-14 start-76 translate-middle badge rounded-pill bg-danger">
    ...
    <span class="visually-hidden">unread messages</span>
      ...
      <ul class="mt-2">
          ...
          <li>
            <a class="active btn" href="Profile_SettingsDash.php" style="background-color:#fff;width:100%;color:#299B63;border:0;border-radius: 0;";>
      ...
      <div class="maindb bg-light">
        ...
        <div class="container-fluid bg-light">
          <div class="tabledb shadow border-top bg-light" style="margin-top: 55px";>
            <h2><i class="fas fa-cog mx-2"></i>Profile Settings</h2>
          ...
          ?>
            ...
            <i class="fa fa-id-card"></i><label for="aaid" class="form-label fw-bold fs-6 m-2">EC ID</label>
            <input type="hidden" class="form-control mb-1" name="aaid" value="<?php echo $row['Admin_ID'] ?>">

            <p class="fw-bold text-success"><?php echo $row['Admin_ID'] ?></p>
              
            
            <i class="fa-solid fa-unlock"></i><label for="rpass" class="form-label fw-bold fs-6 m-2">Reset Password</label>
            <input type="password" class="form-control mb-1" name="rpass" value="<?php echo $row['Admin_Password'] ?>" required>
            
            <i class="fa-solid fa-unlock"></i><label for="ccpass" class="form-label fw-bold fs-6 m-2">Confirm Password</label>
            <input type="password" class="form-control mb-1" name="ccpass" value="<?php echo $row['Admin_Password'] ?>" required>
              
            <div class="row">
              <div class="col-6">
              <i class="fa fa-file-image-o"></i><label for="upad" class="form-label fw-bold fs-6 m-2">Upload New Photo/Reselect</label>
              ...
              <button type="submit" name="updateaspprofile" class="btn btn-primary justify-content-md-end mt-5 shadow">Update</button>


              </div>
              <div class="col-6">
              <p class="text-center fw-bold fs-6 mt-3">EC Image</p>
              <p class="text-center"><?php echo '<img src="data:image/png;base64,' . base64_encode($img) . '" alt="Image">';?></p>
