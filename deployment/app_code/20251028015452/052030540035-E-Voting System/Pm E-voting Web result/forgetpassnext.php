        ...
        <div class="col-lg-5">
          <div class="signupform">
            ...
            if (isset($_POST['verifyaspcode'])) {
              ...
              $sql = "SELECT * FROM admindetails WHERE Otp_Code ='$concatenatedNumbers'";
              ...
              if (mysqli_num_rows($result) === 1) {
                ...
                if ($row['Otp_Code'] === $concatenatedNumbers){
                  ...
                  $_SESSION['status'] = "Your Account Recovery was successful. ". " Your Admin ID: ". $aid. " and Password: ". $pass. " Your can Copy your Password for LogIn";
                  ...
                  $_SESSION['status'] = "Your Admin OPT Code: ". $concatenatedNumbers . " is incorrect. Try again or Resend Code if you didn't recieve any SMS";
