...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Activity Logs</title>
  ...
  <span class="position-absolute top-14 start-76 translate-middle badge rounded-pill bg-danger">
    ...
    <span class="visually-hidden">unread messages</span>
      ...
      <ul class="mt-2">
          ...
          <li>
            <a class="active btn mt-1" href="Active_log.php" style="background-color:#fff;width:100%;color:#299B63;border:0;border-radius: 0;";>
      ...
      <div class="maindb bg-light">
        ...
        <div class="container-fluid bg-light mb-5">
          <div class="tabledb shadow border-top bg-light" style="margin-top: 80px";>
            <h2><i class="fa-solid fa-square-poll-vertical mx-2 mt-2 mb-3"></i>Activity Logs</h2>
            ...
            <table id="example" class="table table-striped table-hover table-responsive">
              ...
              <?php
                ...
                <tr>
                  ...
                  <td> <?php echo $row['Activity_Logs'] ?></td>
