...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Polling Agent </title>
  ...
  ></script> 
    ...
    <a type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
      ...
      <div class="userdb">
        ...
        <ul class="mt-2">
          <li>
            <a href="pollingagent_Page.php" class="active btn" style="background-color:#fff;width:100%;color:#737373;border:0;border-radius: 0;";>
              <i class="fas fa-th-large" style="color:#737373";></i>
              <div>Dashboard</div>
            </a>
          </li>
      ...
      <div class="maindb bg-light" id="content">
        <div class="container-fluid bg-light">
          <div class="rules shadow p-3 bg-light" style="margin-top: 50px;">
          <h4 class="m-2 fs-5"><i class="fa-solid fa-user-tag m-1"></i>Polling Agent Dashboard</h4>
          <p class="mt-4">Here are some rules, regulations, and guidelines that polling agents should adhere to when participating in an election:</p>
          <p class=""><i class="fa-solid fa-circle mx-1" style="font-size: 10px;"></i> <span class="fw-bold">Impartiality and Neutrality:</span><br>
          <span class="container"><b>Rule:</b> Polling agents must remain impartial and neutral, refraining from any actions or statements that could favor a <span class="container"> particular candidate or party.</span></p></span>

          <p class=""><i class="fa-solid fa-circle mx-1" style="font-size: 10px;"></i> <span class="fw-bold">Verification of Voter Eligibility:</span><br>
          <span class="container"><b>Rule:</b>  Polling agents should carefully verify the eligibility of voters based on official voter lists and identification documents.

          <p class=""><i class="fa-solid fa-circle mx-1" style="font-size: 10px;"></i> <span class="fw-bold">Reporting Irregularities:</span><br>
          <span class="container"><b>Rule:</b>  Polling agents should immediately report any irregularities or violations of election laws to the appropriate <span class="container">authorities.</span>

          <p class=""><i class="fa-solid fa-circle mx-1" style="font-size: 10px;"></i> <span class="fw-bold">Communication with Election Authorities:</span><br>
          <span class="container"><b>Guideline:</b>  Polling agents should maintain open and clear communication with election authorities, reporting any issues or <span class="container">seeking guidance when necessary.</span>
