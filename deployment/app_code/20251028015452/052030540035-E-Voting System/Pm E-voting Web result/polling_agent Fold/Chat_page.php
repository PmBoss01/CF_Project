...
<head>
    ...
    <title>Issue Report | Chat EC</title>
...
<script
  ...
  <?php
          ...
          $query = "SELECT * FROM admindetails WHERE Admin_ID = '$content'";
          ...
          <div class="rectangular-bar top">
            <a href="IssueReport.php" class="text-light"><i class="fa fa-long-arrow-left" aria-hidden="true" style="font-size: 20px;margin-left:20px;margin-top: 25px;"></i></a>
            <div class="chatuser">
              <?php echo '<img src="data:image/png;base64,' . base64_encode($img) . '" alt="Image";>';?>
              <div style="margin-left: 12px;">
                <p class="text-light fw-normal mb-0" style="margin-top: -35px;"><?php echo $_SESSION['Admin_ID']; ?></p> 
                ...
                if (mysqli_num_rows($query_run) > 0) {
                  while ($row = mysqli_fetch_array($query_run)) {
                    ...
                    <div>
                      ...
                      if ($sender == $aid) {
                        ?>
                        <p class="custom-left mt-2"><?php echo $Messages ?><span class="float-end mx-2 mt-2" style="font-size: 12px;"><?php echo $Time_Delivered ?><i class="fa fa-check text-success"></i></span></p>
                      <?php
                      } else {
                        ?>
                        <p class="custom-right mt-2"><?php echo $Messages ?><span class="float-start mt-2" style="font-size: 12px;"><?php echo $Time_Delivered ?><i class="fa fa-check text-success"></i></span></p>
                        <?php
                      }
                      ?>
                    </div>
