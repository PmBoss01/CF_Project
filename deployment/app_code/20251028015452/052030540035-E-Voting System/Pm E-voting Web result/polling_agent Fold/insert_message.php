...
if (isset($_POST['message'])) {
    ...
    $sql = "INSERT INTO chats (Sender, Receiver, Messages, Time_Delivered) VALUES ('$Aid','$ECname','$message','$currentTimestamp')";

    if (mysqli_query($conn, $sql)) {
        // Create HTML for the newly added message
        $html = '<div><p class="custom-left mt-2">' . $message . '<span class="float-end mt-2" style="font-size: 12px;">' . $currentTimestamp . '<i class="fa fa-check text-success"></i></span></p></div>';
