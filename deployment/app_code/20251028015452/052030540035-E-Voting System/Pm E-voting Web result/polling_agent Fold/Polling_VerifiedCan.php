    ...
    <a type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
      ...
      <div class="userdb">
        ...
        <ul class="mt-2">
          ...
          <li>
            <a class="btn active mt-1" href="Polling_VerifiedCan.php" style="background-color:#fff;width:100%;color:#737373;border:0;border-radius: 0;">
            <i class="fa fa-user-o" style="color:#737373"></i>
      ...
      <div class="maindb bg-light" id="content">
        <div class="container-fluid">
          ...
          <h2><i class="fa fa-user-o mx-2"></i>Verified Candidates</h2>
          ...
          ?>
              ...
              <?php
                ...
                <tr>
                  ...
                  <td><label for="reg" class="bg-success text-white shadow" style="border-radius: 5px;padding: 10px 15px;">Verified</label></td>
