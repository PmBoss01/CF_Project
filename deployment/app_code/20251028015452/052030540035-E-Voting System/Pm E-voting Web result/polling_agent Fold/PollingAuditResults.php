...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Audit Result </title>
    ...
    <a type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
      ...
      <div class="userdb">
        ...
        <ul class="mt-2">
          ...
          <li>
            <a class="btn active mt-1" href="PollingAuditResults.php" style="background-color:#fff;width:100%;color:#737373;border:0;border-radius: 0;">
            <i class="fa-solid fa-eye" style="color:#737373"></i>
      ...
      <div class="maindb bg-light" id="content">
        <div class="container-fluid">
          <div class="rules shadow p-3" style="margin-top: 50px;margin-bottom: 80px;">
          
          <h2><i class="fa-solid fa-eye mx-2"></i>Audit Results</h2>
          <table id="example" class="table table-striped table-hover table-responsive">
          <?php
          include('db_conn.php');
          $query = "SELECT * FROM candidate_result";
          $query_run = mysqli_query($conn, $query)
          ...
          ?>
            ...
            <form action="../polling_agent_Conn.php" method="post">
            <div class="d-flex justify-content-center align-items-center mt-4">
            <div class="mb-3 form-check mt-3">
            <input type="checkbox" class="form-check-input" id="exampleCheck1" required>
            <label class="form-check-label" for="exampleCheck1">Audited and Certified Results</label>
        </div>

        <button type="submit" class="btn btn-success mx-2 shadow" name="yes">Yes!!</button>
        <button type="submit" class="btn btn-danger mx-1 shadow" name="no">No!!</button>
