    ...
    <a type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
      ...
      <div class="userdb">
        ...
        <ul class="mt-2">
          ...
          <li>
            <a class="active btn mt-1" href="polling_profile.php" style="background-color:#fff;width:100%;color:#737373;border:0;border-radius: 0;";>
            <i class="fa fa-user-cog" style="color:#737373";></i>
      ...
      <div class="maindb bg-light">
        ...
        <div class="container-fluid bg-light">
          ...
          ?>
            ...
            <form action="PollingProfile_conn.php" method="post" enctype="multipart/form-data">
              
            <i class="fa fa-id-card"></i><label for="aaid" class="form-label fw-bold fs-6 m-2">Polling ID</label>
            <input type="text" class="form-control mb-1" name="aaid" value="<?php echo $row['Agent_ID'] ?>" required>
              
            
            <i class="fa-solid fa-unlock"></i><label for="rpass" class="form-label fw-bold fs-6 m-2">Reset Password</label>
            <input type="password" class="form-control mb-1" name="rpass" value="<?php echo $row['Agent_Password'] ?>" required>
            
            <i class="fa-solid fa-unlock"></i><label for="ccpass" class="form-label fw-bold fs-6 m-2">Confirm Password</label>
            <input type="password" class="form-control mb-1" name="ccpass" value="<?php echo $row['Agent_Password'] ?>" required>
            ...
            <div class="row">
              ...
              <div class="col-6">
              <p class="text-center fw-bold fs-6 mt-3">Polling Agent Image</p>
