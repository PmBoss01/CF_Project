  ...
  <div class="container-fluid bg-light" style="margin-top: 50px;">
    <div class="card shadow mt-3">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-black"><i class="fa-solid fa-graduation-cap mx-1"></i>EDIT VOTER INFORMATION</h6>
        </div>
        <div class="card-body">
            <?php
            if(isset($_POST['studenteditbtn'])){
                ...
                $query = "SELECT * FROM votersdetails WHERE Student_ID  = '$sid'";
                $query_run = mysqli_query($conn, $query);
                ...
                <label for="id" class="form-label fw-bold fs-6 m-2" >Voter ID</label>
                <p class="text-success m-2 fs-4 mt-0 mb-0 fw-bold"><?php echo $row['Student_ID'] ?></p>


            <label for="name" class="form-label fw-bold fs-6 m-2" >Voter Name</label>
           ...
           <select id="validationDefault04" class="form-select" name="Department" required>
            <option selected disabled value=""><?php echo $row['Department']?></option>
                <?php include 'Department_SelectConn.php'; ?>
           </select>

          <div class="modal-footer">
            <button type="submit" name="updatestudentinfo" class="btn btn-primary justify-content-md-end">Update</button>
          </div>
                </form>
            <?php
                }
