    ...
    <span class="visually-hidden">unread messages</span>
      ...
      <div class="maindb bg-light">
        ...
        <div class="container-fluid bg-light">
          <div class="tabledb shadow border-top" style="margin-top: 80px";>
            <h2><i class="fa-solid fa-graduation-cap mx-2"></i>Voter Registration</h2>
            
            <form action="Registrations_Conn.php" method="post" enctype="multipart/form-data" class="bg-light">
            <p class="text-center mb-0"><i class="fa fa-id-card"></i><label for="aid" class="form-label fw-bold fs-6 m-2">Voter ID</label></p>
            <input type="text" class="form-control mb-1 text-center" id="idadmin" name="sid" placeholder="Enter Your Voter ID" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxLength="12" required>

    
            <div class="row">
              <div class="col-6">
            <p class="text-center mb-0 mt-3"><i class="fa fa-graduation-cap" aria-hidden="true"></i><label for="name" class="form-label fw-bold fs-6 m-2">Voter Name</label></p>
            <input type="text" class="form-control mb-3 text-center" id="name" name="sname" placeholder="Enter Voter Name" required>
            </div>
            <div class="col-6">
            <p class="text-center mb-0 mt-3"><i class="fa fa-phone" aria-hidden="true"></i><label for="pno" class="form-label fw-bold fs-6 m-2">Phonenumber</label></p>
            <input type="text" class="form-control mb-3 text-center" name="spno" placeholder="Enter Student Phonenumber" oninput="this.value = this.value.replace(/[^0-9]/g, '')" maxLength="10" required>
              </div>

              <div class="col-12">
                <p class="text-center mb-0 mt-3"><label for="department" class="form-label fw-bold fs-6 m-2">Select Department</label></p>
              <select id="validationDefault04" class="form-select text-center" name="department" required>
                <option selected disabled value="">~Select~</option>
                <?php include 'Department_SelectConn.php'; ?>
            </select>
            ...
            <div class="modal-footer d-flex justify-content-end">
              <button type="submit" name="registervoterbtn" class="btn btn-primary shadow">Register</button>
            </div>
          </form>
          ...
          <!--Upload voter File-->
          <div class="tabledb shadow border-top bg-light" style="margin-top: 70px; margin-bottom:80px;">
            <h2><i class="fa-solid fa-file mx-2 mb-3"></i>Upload Voter List (Bulk)</h2>
            <form action="Registrations_Conn.php" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col-6">
                  <label for="upload" class="form-label fw-bold">Select File</label>
                  <input type="file" name="uploadcsvfile" class="form-control" accept=".csv" required>
                  <div id="emailHelp" class="form-text">Upload Only <span class="text-danger fw-bold">.csv</span> file</div>
                </div>

                <div class="col-6">
                  <label for="upload" class="form-label fw-normal">Please Specify whether your <span class="text-danger fw-bold">Excel file</span> has header or Not. <br>With headers eg. [Student ID, Name, Contact, Department]. Download Sample here<a href="sample.csv" download class="text-decoration-none fw-bold"><i class="fa fa-download mx-1"></i>Download</a></label>
                  
                  <div class="d-flex justify-content-center">
                  <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="radio" id="inlineRadio1" value="remove" required>
                  <label class="form-check-label" for="inlineRadio1">Header</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="radio" id="inlineRadio2" value="No Header" required>
                  <label class="form-check-label" for="inlineRadio2">No Header</label>
                </div>
                </div>
                ...
                <div class="d-flex justify-content-end mt-4">
                  <button class="btn btn-secondary" type="submit" name="importbtn"><i class="fa fa-upload mx-1" aria-hidden="true"></i>Import File</button>
                </div>
              </div>
