      ...
      <div class="maindb bg-light">
        ...
        <div class="container-fluid bg-light">
          <div class="tabledb shadow border-top" style="margin-top: 80px";>
            <h2><i class="fas fa-user-plus mx-2"></i>Add New EC Account</h2>
            
            <form action="Newadmincode.php" method="post" enctype="multipart/form-data" class="bg-light">
            <i class="fa fa-id-card"></i><label for="aid" class="form-label fw-bold fs-6 m-2">EC ID</label>
            <input type="text" class="form-control mb-1" id="idadmin" name="aid" placeholder="Enter Your EC ID" required>

            <i class="fa fa-file-image-o"></i><label for="upad" class="form-label fw-bold fs-6 m-2">Upload EC Photo</label>
            <input type="file" class="form-control mb-1" name="photo" id="imageInput" onchange="displayImage(event)"id="photos" accept=".png,.jpg,.jpeg" required>
            <div id="uploadnotice" class="form-text">Upload Size: eg: <span style="color:#af0000;">135px X 135px</span>. Extension: <span style="color:#af0000;">.png .JPG .jpeg</span></div>
            
            <div class="row">
              <div class="col-6">
            <i class="fa-solid fa-unlock"></i><label for="pass" class="form-label fw-bold fs-6 m-2">Choose a Password</label>
            <input type="password" class="form-control mb-3" id="passwordadmin" name="pass" placeholder="Enter Your Password" required>
            </div>
            <div class="col-6">
            <i class="fa-solid fa-unlock"></i><label for="cpass" class="form-label fw-bold fs-6 m-2">Confirm Password</label>
            <input type="password" class="form-control mb-3" name="cpass" placeholder="Confirm Password" required>
              </div>
            </div>

            <div class="modal-footer d-flex justify-content-between">
            <img src="" alt="Upload Image" id="previewImage" style="width: 135px;height:135px">
              <button type="submit" name="save" class="btn btn-primary shadow">Save</button>
            </div>
          </form>
          ...
          <h2><i class="fas fa-user-plus mx-2"></i>Admin Account Table</h2>
          ...
          ?>
              ...
              <?php
                ...
                <tr>
                  ...
                  <td class="status">
                    <label class="bg-success"><span class="spinner-grow spinner-grow-sm" role="status" aria-hidden="true"></span>Active</label>
                  </td>
                  <td class="status-btn">
                  <form action="Newadmincode.php" method="post">
                    <input type="hidden" name="deleteadmin" value="<?php echo $row['Admin_ID']; ?>">
                    <button type="submit" name= "Admindelete" class="btn bg-danger text-white"><i class="fa fa-trash"></i></button>
                  </form>
                  </td>
