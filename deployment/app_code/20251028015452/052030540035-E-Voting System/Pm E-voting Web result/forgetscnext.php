        ...
        <div class="col-lg-5">
          <div class="signupform">
            ...
            if (isset($_POST['verifycode'])) {
              ...
              $sql = "SELECT * FROM votersdetails WHERE Otp_Code ='$concatenatedNumbers'";
              $result = mysqli_query($conn, $sql);
              if (mysqli_num_rows($result) === 1) {
                $row = mysqli_fetch_assoc($result);
                if ($row['Otp_Code'] === $concatenatedNumbers){
                  $sid = $row['Student_ID'];
                  $scode = $row['Serial_Code'];
                  $_SESSION['status_title'] = "Authetication!";
                  $_SESSION['status'] = "Your Account Recovery was successful. ". " Your Student ID: ". $sid. " and Serial Code: ". $scode. " Your can Copy your Serial Code for LogIn";
            ...
            ?>
              ...
              >
                ...
                <i class="fa-solid fa-key mx-2"></i>OTP Code
                </h6>
              </div>
            ...
            <strong>Please, </strong>Enter A valid 4-digit OTP code that have been sent via your Phonenumber.
              ...
              <div class="container">
                ...
                <div
                  class="d-grid mt-3"
                >
                  <button type="submit" name="verifycode" id="myButton" class="btn btn-primary shadow-sm mb-3 mt-3">
                    Verify Code 
                  </button>
                  <p class="text-center mb-2"><a href="forgetsc.php" class="text-decoration-none">Resend Code</a></p>
