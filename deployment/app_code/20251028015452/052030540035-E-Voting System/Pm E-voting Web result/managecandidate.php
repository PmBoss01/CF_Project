...
<html lang="en">
  <head>
    ...
    <title>Manage Record | Candidate</title>
    ...
    <span class="visually-hidden">unread messages</span>
      ...
      <div class="maindb bg-light">
        <div class="container-fluid bg-light">
          ...
          <h2><i class="fa fa-user-check mx-2"></i>Managae Candidate</h2>
          ...
          ?>
              ...
              <?php
                ...
                <tr>
                  ...
                  <td> 
                  <form action="UpdateCanInfo.php" method="post">
                    <input type="hidden" name="editcid" value="<?php echo $row['Student_ID']?>">
                    <button type="submit" name="caneditbtn" class="btn bg-success text-white"><i class="fa fa-pencil-square-o"></i></button>
                  </form>
                  </td>
                  <td>
                  <form action="edit_deleteCan.php" method="post">
                    <input type="hidden" name="deletecid" value="<?php echo $row['Student_ID']; ?>">
                    <button type="submit" name= "candeletebtn" class="btn bg-danger text-white"><i class="fa fa-trash"></i></button>
                  </form>
                  </td>
            ...
            <a class="btn btn-success mt-5" href="exportcanlist.php" type="submit" name="exportbtn"><i class="fa fa-download mx-2" aria-hidden="true"></i>Export Candidate List</a>
            </div>

            <form action="Truncate_VotersList.php" method="POST">
            <div class="d-grid gap-2">
            <button class="btn btn-danger mt-2" type="submit" name="truncatecanbtn"><i class="fa fa-trash mx-2" aria-hidden="true"></i>Remove All Voters</button>
          </div>
          </form>
