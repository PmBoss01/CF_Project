...
<html lang="en">
  <head>
    ...
    <title>Student LogIn | Cast Votes</title>
  ...
  <body class="bg-light">
        ...
        <div class="col-sm-6">
          ...
          ?>
                <form>
                    ...
                    <p class="mb-4 text-center fs-5">Voting Period Is<b class="outsoon"> CLOSED</b></p>
                    ...
                    <p class="tp align-left"><b>Voting Status: <span><?php echo $row['Voting_Status'] ?></span></b> </p>
    ...
    <div class="d-flex justify-content-center">
      <a href="Homepage.php" class="btn btn2 m-1 shadow"><i class="fa fa-home mx-1"></i>Go Home</a>
      <a href="StudentLogin.php" class="btn btn2 m-1 shadow"><i class="fa fa-eye mx-1"></i>View Results</a>
    </div>
