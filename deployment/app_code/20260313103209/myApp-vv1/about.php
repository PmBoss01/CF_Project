...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .stat-info .num { font-weight: 700; font-size: 1.1rem; color: #fff; line-height: 1; }
    .stat-info .lbl { font-size: 0.7rem; color: var(--muted); margin-top: 2px; }
    ...
    .text-side h1 em { font-style: italic; color: var(--red); }
    ...
    .role-line::before { content: ''; width: 28px; height: 1px; background: var(--red); }

    .bio { font-size: 1rem; line-height: 1.8; color: rgba(240,236,238,0.75); margin-bottom: 36px; }
    ...
    .divider { border: none; border-top: 1px solid var(--border); margin: 70px 0; animation: fadeUp 0.7s 0.3s ease both; }

    .section-label { font-size: 0.72rem; font-weight: 600; letter-spacing: 0.14em; text-transform: uppercase; color: var(--red); margin-bottom: 14px; }
    ...
    .services { display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; animation: fadeUp 0.7s 0.4s ease both; }
    ...
    .service-card h3 { font-size: 1rem; font-weight: 600; color: #fff; margin-bottom: 10px; position: relative; z-index: 1; }
    .service-card p { font-size: 0.83rem; line-height: 1.7; color: var(--muted); position: relative; z-index: 1; }
    ...
    .stat-block { background: var(--card); padding: 32px 28px; text-align: center; }
    ...
    .stat-block .desc { font-size: 0.8rem; color: var(--muted); font-weight: 500; }

    .footer { margin-top: 70px; text-align: center; font-size: 0.78rem; color: var(--muted); animation: fadeUp 0.7s 0.6s ease both; }
...
$logged_in_user = htmlspecialchars($_SESSION['username'] ?? 'User');
?>
